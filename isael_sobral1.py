    ...
    try: #Vai tentar fazer a conexão com a página WEB
        ...
        for i in listaComResultado: #Percorre a lista encontrada.
            ...
            if atributoNome != None and atributoConteudo != None: #Criada para não armazenar os atributos diferentes de name e content dentro das Meta Tags.
                #Preenche a lista com o nome e contéudo.
                listaNomeEConteudo.append(atributoNome)
                listaNomeEConteudo.append(atributoConteudo)

        minhaJSON = json.dumps(listaNomeEConteudo, indent=2) #Aqui converte a lista preenchida com os valores em uma JSON identada com 2 espaços.
        print("JSON com uma lista contendo todos os valores que estão armazenados nos atributos name e content das Meta Tags encontradas.")
